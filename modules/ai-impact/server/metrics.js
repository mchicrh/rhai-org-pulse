 ...
 *
 * Denominator is AI-touched RFEs only (aiInvolvement !== 'none') so rates
 * reflect "of pipeline runs, how many had this outcome?" rather than being
 * diluted by manually-filed RFEs the pipeline never processed.
 *
 * Trend direction is inverted vs adoption: lower friction = improving.
 *
 ...
 * @returns {{ needsAttentionPct, needsAttentionChange, needsAttentionTrend,
